...
import com.example.demo.dataStructures.exception.*;

import java.awt.*;
import java.util.Queue;
import java.util.*;
public class AdjacentListGraph<V> extends Graph<V> {
    private ArrayList<AdjacentListVertex<V>> vertex;
    private LinkedHashMap<V, Integer> index;
    private boolean isDirected;
    private int time;

    public AdjacentListGraph(boolean directed) {
        isDirected = directed;
    ...
    @Override
    public void addEdge(V source, V destination, int weight) throws VertexNotFoundException {
